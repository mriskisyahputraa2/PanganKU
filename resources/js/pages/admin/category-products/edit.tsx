...
// Menerima props 'category', 'updateUrl', dan 'indexUrl' dari controller
export default function EditCategory({ category, updateUrl, indexUrl }) {
    const { data, setData, put, errors, processing } = useForm({
        name: category.name || '', // Inisialisasi form dengan data yang ada
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        // Kirim data update ke URL yang diberikan oleh props 'updateUrl'
        put(updateUrl);
    };
